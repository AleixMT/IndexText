...
public interface TADArbreBinari<E> {
	...
	// Operacions que complementen l'especificaci� b�sica dels arbres binaris
	...
	/**
	 * M�tode que retorna la llista d'elements de l'arbre segons el recorregut preordre
	...
	/**
	 * M�tode que retorna la llista d'elements de l'arbre segons el recorregut postordre
